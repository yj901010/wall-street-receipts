...
export default defineConfig({
  ...
  outputDir: fileURLToPath(new URL("../.cache/comparative-scoring-full-stack/public", import.meta.url)),
  ...
  webServer: {
    ...
    env: { COMPARATIVE_SCORING_RECEIPTS_PROVIDER: "disabled", CALL_AUDIT_PROVIDER: "fixture", NEXT_TELEMETRY_DISABLED: "1" },
  },
});
