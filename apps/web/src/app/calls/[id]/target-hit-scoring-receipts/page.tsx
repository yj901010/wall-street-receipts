...
import { CALL_ID, RECEIPT_ID, type ReceiptState } from "@/lib/target-hit-scoring-receipts";
import { loadTargetHitScoringReceipts } from "@/lib/target-hit-scoring-receipts.server";
import { ReceiptView } from "./receipt-view";

export const dynamic = "force-dynamic";
export default async function TargetHitScoringReceiptPage({ params, searchParams }: {
  ...
  const state: ReceiptState = valid ? await loadTargetHitScoringReceipts(id, selectedId || undefined) : {kind: "invalid"};
