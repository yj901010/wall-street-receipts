...
import { CALL_ID, RECEIPT_ID, type ReceiptState } from "@/lib/comparative-scoring-receipts";
import { loadComparativeScoringReceipts } from "@/lib/comparative-scoring-receipts.server";
import { ReceiptView } from "./receipt-view";

export const dynamic = "force-dynamic";
export default async function ComparativeScoringReceiptPage({ params, searchParams }: {
  ...
  const state: ReceiptState = valid ? await loadComparativeScoringReceipts(id, selectedId || undefined) : {kind: "invalid"};
