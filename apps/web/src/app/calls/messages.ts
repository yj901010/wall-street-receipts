...
const ko = {
  list: {
    ...
    from: "시작일(KST)",
    throughDate: "종료일(KST)",
    throughDateNote: "선택한 한국 날짜의 다음 날 00:00 KST를 제외 상한으로 적용합니다.",
    dataMode: "데이터 모드",
    allModes: "모든 모드",
    sortBy: "정렬 기준",
    eventTime: "이벤트 시각",
...
const en = {
  list: {
    ...
    from: "From date (KST)",
    throughDate: "Through date (KST)",
    throughDateNote: "Applied as the next Korean calendar day's exclusive 00:00 KST bound.",
    dataMode: "Data mode",
    allModes: "All modes",
    sortBy: "Sort by",
