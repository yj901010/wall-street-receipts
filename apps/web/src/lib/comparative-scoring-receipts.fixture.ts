import { RECEIPT_METHOD_HASH, type ComparativeScoringReceipt, type ReferenceEvidence } from "./comparative-scoring-receipts";

/** Synthetic wire fixture, never a runtime fallback or an observed receipt. */
export function sampleReceipt(): ComparativeScoringReceipt {
  ...
  return { benchmarkReturn: {state: "AVAILABLE", decimalValue: "0.100000000000", booleanValue: null, reasons: []},
    ...
    methodologyId: "wsr-demo-comparative-preview", methodologyVersion: "1.0.0", methodologyDefinitionHash: RECEIPT_METHOD_HASH,
    ...
    recordedAtUtc: "2026-01-06T00:01:00.123456Z", recordedAtKst: "2026-01-06T09:01:00.123456+09:00", dataMode: "DEMO", scope: "PARTIAL_COMPARATIVE", dataComplete: false,
