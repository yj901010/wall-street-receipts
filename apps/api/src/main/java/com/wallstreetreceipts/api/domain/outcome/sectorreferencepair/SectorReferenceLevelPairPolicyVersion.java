...
/** Versioned exact sector reference-level-pair policy. */
public enum SectorReferenceLevelPairPolicyVersion {
    POINT_IN_TIME_EXACT_SECTOR_PRICE_INDEX_LEVEL_PAIR_V1;

    private static final String CANONICAL_DEFINITION =
            "{\"policyVersion\":\"POINT_IN_TIME_EXACT_SECTOR_PRICE_INDEX_LEVEL_PAIR_V1\","
            + "\"requiredAssignmentPolicyVersion\":\"POINT_IN_TIME_EXPLICIT_WSR_ECONOMIC_ACTIVITY_SECTOR_ASSIGNMENT_V1\","
            + "\"requiredAssignmentPolicyDefinitionHash\":\"52d9f705a3a8a965a6fca79d36bd94ed8836642f1a2c4e5f29a878d0a267311c\","
            ...
            + "\"requiredTaxonomyId\":\"wsr-economic-activity\","
            + "\"requiredTaxonomyVersion\":\"1.0.0\","
            + "\"requiredTaxonomyDefinitionHash\":\"820ce3ea264d67312fe4f2efe346631a81d74248e9a7f041793d65d8ef0d62ae\","
            ...
            + "\"requiredReferenceAssetType\":\"INDEX\","
            ...
            + "\"fxConversion\":\"ABSENT\","
            + "\"referenceSpecificIdentity\":\"referenceAssetId,referenceAssetType,calculationVenueId,calendarId,calendarRevision,calendarSourceId,calendarSourceRevision,levelSourceId,levelSourceRevision,continuitySourceId,continuitySourceRevision\","
            + "\"bindingChain\":\"referenceIndexEvidence.mappingEvidenceId,mappingProviderEventId==selectedMappingEvidence.identity\","
            + "\"levelChain\":\"level.referenceIndexEvidenceId,referenceIndexProviderEventId,referenceAssetId,referenceAssetType==selectedReferenceIndexEvidence.identityAndCanonicalAsset\","
            + "\"continuityChain\":\"continuity.referenceIndexEvidenceId,referenceIndexProviderEventId,referenceAssetId,referenceAssetType==selectedReferenceIndexEvidence.identityAndCanonicalAsset&&basisAndEndpointObservationLinksExact\","
            ...
            + "\"hashValidation\":\"LOWERCASE_SHA_256_HEX_64\","
