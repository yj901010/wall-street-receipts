...
/** Versioned signed benchmark price-index return formula and output policy. */
public enum BenchmarkReturnPolicyVersion {
    SIGNED_BENCHMARK_BASIS_LEVEL_DENOMINATOR_SCALE_12_HALF_EVEN_V1;

    private static final String CANONICAL_DEFINITION =
            "{\"policyVersion\":\"SIGNED_BENCHMARK_BASIS_LEVEL_DENOMINATOR_SCALE_12_HALF_EVEN_V1\","
            + "\"requiredReferenceLevelPairPolicyVersion\":\"POINT_IN_TIME_EXACT_BENCHMARK_PRICE_INDEX_LEVEL_PAIR_V1\","
            + "\"requiredReferenceLevelPairPolicyDefinitionHash\":\"2394b535c1061d32c647504a303b6f1e4ec2fe88e6017d9ff335d12087a5f73d\","
            + "\"referenceLevelPairInput\":\"BENCHMARK_REFERENCE_LEVEL_PAIR_RESOLUTION\","
            + "\"resultContextFields\":[\"policyVersion\",\"policyDefinitionHash\",\"referenceLevelPairResolution\"],"
            + "\"resultVariants\":{\"Available\":[\"context\",\"benchmarkReturn\"],\"NotApplicable\":[\"context\"],\"AssignmentUnavailable\":[\"context\"],\"EndpointAnchorUnavailable\":[\"context\"],\"EvidenceUnavailable\":[\"context\"],\"OutputUnavailable\":[\"context\",\"reason\"]},"
            ...
            + "\"sectorReturnResultReuse\":\"FORBIDDEN\","
            + "\"resultContext\":\"POLICY_IDENTITY_AND_COMPLETE_BENCHMARK_REFERENCE_LEVEL_PAIR_RESOLUTION_ONLY\","
