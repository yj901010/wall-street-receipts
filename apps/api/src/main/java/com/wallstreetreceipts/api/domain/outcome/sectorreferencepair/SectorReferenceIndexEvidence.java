...
/** One reusable canonical WSR leaf to provider-published reference-index binding. */
public record SectorReferenceIndexEvidence(
        String referenceIndexEvidenceId,
        String providerEventId,
        String mappingEvidenceId,
        String mappingProviderEventId,
        String taxonomyId,
    ...
    public SectorReferenceIndexEvidence {
        ...
        requireCanonicalText(mappingEvidenceId, "mappingEvidenceId");
        requireCanonicalText(mappingProviderEventId, "mappingProviderEventId");
        requireCanonicalText(taxonomyId, "taxonomyId");
        requireCanonicalText(taxonomyVersion, "taxonomyVersion");
        requireSha256(taxonomyDefinitionHash, "taxonomyDefinitionHash");
        requireCanonicalText(canonicalNodeId, "canonicalNodeId");
        requireCanonicalText(referenceAssetId, "referenceAssetId");
