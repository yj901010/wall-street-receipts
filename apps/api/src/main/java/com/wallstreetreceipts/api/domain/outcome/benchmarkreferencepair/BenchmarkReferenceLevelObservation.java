...
/** One immutable provider-identified benchmark reference-level observation. */
public record BenchmarkReferenceLevelObservation(
    ...
    public BenchmarkReferenceLevelObservation {
