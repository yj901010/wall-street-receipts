...
FIXED_CI_PATHS = frozenset({
    ...
    "decisions/ADR-066-isolated-cpi-worker-container.md",
    "scripts/ci/test_cpi_worker_contracts.py",
    "decisions/ADR-067-read-only-cpi-worker-status.md",
    ...
    "decisions/ADR-073-cpi-read-only-operator-access.md",
    ...
    "decisions/ADR-083-demo-comparative-scoring-input.md",
    "decisions/ADR-084-demo-comparative-receipt-persistence.md",
    "decisions/ADR-085-demo-comparative-receipt-command-and-audit.md",
    "decisions/ADR-086-demo-target-hit-scoring-input.md",
    "decisions/ADR-087-demo-target-hit-receipt-persistence.md",
    "decisions/ADR-088-demo-target-hit-receipt-command-and-audit.md",
